import{r as P,b as R}from"./vue.esm-bundler-DHmVcdJx.js";import{l as E,c as h}from"./index-BZRD67xE.js";import"./vExtractRootEl-DbajM-JB.js";import"./twMerge-Bw-RVb8v.js";const A={component:E,args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:r=>({components:h,setup:()=>{const a=P(r._start);if(r.progress)a.value=r.progress;else{const x=setInterval(()=>{a.value>=100?a.value=0:a.value+=r._add},r._timeout);R(()=>{clearInterval(x)})}return{args:{...r},progress:a}},template:`
