import{r as s}from"./vue.esm-bundler-DHmVcdJx.js";import{g,c as E}from"./index-BZRD67xE.js";import"./vExtractRootEl-DbajM-JB.js";import"./twMerge-Bw-RVb8v.js";const _={component:g,args:{values:["A","B","C"],border:!0}},e={render:r=>({components:{...E,LibMultiValues:g},setup:()=>{const a=s("B"),h=s(null);return{args:r,inputValue:a,multiValueEl:h,onKeydownEnter:f=>{f.key==="Enter"&&r.values.push(a.value)}}},template:`
